...
st.image('/Users/evejacob/code/Evej2000/artsy-fartsci/artsy-fartsci-front/assets/Alex-circle.png')
st.text('Alex Sweetman')
st.markdown('http://github.com/Sweetmanco')

st.image('/Users/evejacob/code/Evej2000/artsy-fartsci/artsy-fartsci-front/assets/Molly-circle.png')
st.text('Molly Lister')
st.markdown('https://github.com/molpl')

st.image('/Users/evejacob/code/Evej2000/artsy-fartsci/artsy-fartsci-front/assets/Kamran-circle.png')
st.text('Kamran Ardabili')
st.markdown('https://github.com/CheekyMonkeyCoder')

st.image('/Users/evejacob/code/Evej2000/artsy-fartsci/artsy-fartsci-front/assets/Eve-circle.png')
st.text('Eve Jacob')
