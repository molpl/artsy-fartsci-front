...
def main():
    ...
    if uploaded_file:
        ...
        progress_text1 = ":blue[Going to Art School]:artist:"
        progress_text2 = ":blue[Unpacking Paint and Brushes]:lower_left_paintbrush::art:"
        progress_text3 = ":blue[Painting Your New Artistic World]:frame_with_picture:"
